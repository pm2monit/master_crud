<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <h3 style="display:block; text-align:center;">Tambah Data Production</h3>

  <form id="form-tambah-produk" method="POST">
    <input type="hidden" name="date_insert" value="<?php echo date('yy-m-d'); ?>">
    <input type="hidden" name="date_update" value="<?php echo date('yy-m-d'); ?>">
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
        <i class="glyphicon glyphicon-user"></i>
      </span>
      <input type="text" class="form-control" placeholder="Nama Produk" name="nama_produk" aria-describedby="sizing-addon2">
    </div>
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Deskripsi Produk" name="deskripsi_produk" aria-describedby="sizing-addon2">
    </div>
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="Stok Awal" name="stok" aria-describedby="sizing-addon2">
    </div>
